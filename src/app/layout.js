...
export const metadata = {
  ...
  description:
    "Reviving the Ummah through sacred Islamic knowledge, Quranic teachings, and spiritual growth resources for a global Muslim community.",
  ...
  twitter: {
    ...
    title: "حدائق الجنة - Sacred Islamic Knowledge",
    description:
      "Reviving the Ummah with Quranic and Sunnah teachings for spiritual growth and learning.",
  },
  icons: {
    icon: "/favicon.ico",
  },
