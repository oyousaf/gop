export default function Banner() {
  return (
    <div id="welcome" className="w-full h-72 mt-[100] flex justify-center items-center bg-gradient-to-r from-background to-teal-700 relative overflow-hidden shadow-lg">
