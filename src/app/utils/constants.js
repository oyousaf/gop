...
export const boycott = [
  ...
  { name: "Fila", reason: "The technical sponsor of Maccabi Tel Aviv FC, an Israeli football club, since 2019." },
  ...
  { name: "Sara Lee", reason: "Owns 30% of Israels leading textile company Delta Galil" },
  ...
  { name: "Taffix", reason: "Manufactured by an Israeli company (Nasus Pharma)." },
  { name: "Tata", reason: "Provides IT and cloud services to the Israeli military and supplies Land Rover vehicles to the Israeli military." },
  { name: "Tesla", reason: "Announced free use of all its Superchargers in Israel." },
  { name: "Thomas (Bagel/Biscuits)", reason: "Owned by Bimbo." },
  { name: "Thompson's WaterSeal", reason: "Owned by Sherwin-Williams, known to support Israeli military." },
  ...
  { name: "Under Armour", reason: "Support of various Israeli sports teams and athletes." },
  ...
  { name: "Victoria’s Secret", reason: "Owner Les Wexner is a supporter of Israel." },
  ...
  { name: "Waitrose", reason: "Has been known to sell products sourced from Israel." },
  { name: "Walmart", reason: "Pledged $1m to Israeli victims." },
  { name: "Wells Fargo", reason: "Was part of $500 million loan deal into EBIT Systems Ltd, an Israeli company." },
  ...
  { name: "Wrigley’s Company", reason: "Invested in Israeli food tech startups through JVC." },
  ...
  { name: "Ziff Davis", reason: "Partnered with BrandStorm Media to launch IGN Israel." },
  { name: "Zhou Nutrition", reason: "Sources its black seed oil directly from Israel." },
